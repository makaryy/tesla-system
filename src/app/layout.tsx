        ...
        <html lang="pl">
            <body className={twMerge(montserrat.className)}>
                ...
                <main className="flex flex-col items-stretch w-full gap-8 lg:gap-16">
                    <section className="relative flex flex-wrap gap-6 px-7 lg:px-20 pb-6 pt-20 justify-between items-center bg-fixed bg-cover bg-[url('/hero.jpg')] min-h-screen w-full before:content-[''] before:absolute before:inset-0 before:bg-black/50">
                        <div className="relative space-y-4 max-w-7xl mx-auto">
                            ...
                            <article className="space-y-12 flex-1 min-w-xs text-bg-100/90 ">
                                <p className="text-lg">
                                    Specjalizujemy się w dostarczaniu najlepszej jakości rozwiązań ochrony i bezpieczeństwa Twojej własności
                                    i ukochanych. Z naszymi najnowocześniejszymi systemami i doświadczonym zespołem możesz mieć pewność, że
                                    jesteś w dorych rękach.
                                </p>

        ...
        <>
            <Section className="flex flex-col lg:flex-row px-4 py-6 lg:py-12 justify-between items-center gap-4 lg:gap-8">
                ...
                <div className="flex-[1_1_50%] w-full">
                    <Image className="aspect-square w-full object-cover rounded-md" src="/cables.jpg" alt="" width={1440} height={810} />
                </div>
            </Section>
            <Section className="flex flex-col lg:flex-row px-4 py-6 lg:py-12 justify-between items-center gap-4 lg:gap-8">
                <div className="flex-[1_1_50%]">
                    ...
                    <article className="space-y-3 flex-1 min-w-xs ">
                        ...
                        <div className="flex gap-4 my-6">
                            <button className="border-2 border-text-100 px-4 py-2 rounded-md text-text-100 capitalize text-sm hover:shadow-md transition-shadow">
                                Więcej informacji
                            </button>
            ...
            <Section className="px-4 my-12 lg:my-36">
                <article className="relative space-y-12 rounded-lg text-bg-100 overflow-hidden p-7 lg:p-16 bg-[url('/maintenance.jpg')] before:content-[''] before:absolute before:inset-0 before:bg-black/50 bg-cover">
                    ...
                    <p className="relative text-lg lg:max-w-3xl">
                        ...
                        pożaru i instalacji elektrycznych w optymalnym stanie. Regularne przeglądy i naprawy zapewniają prawidłowe działanie
                        wszystkich systemów i spokój ducha.
                    </p>
                </article>
            </Section>
        </>

    ...
    return (
        <>
            ...
            <div className="flex flex-col items-stretch max-w-8xl mx-auto lg:px-20 gap-8 lg:gap-16">
                    ...
                    <div className="flex-[1_1_50%]">
                        ...
                        <article className="space-y-3 flex-1 min-w-xs ">
                            <p className="text-lg pb-3">
                                Nasza oferta systemów CCTV oferuje najnowocześniejsze funkcje i zaawansowaną technologię, aby zapewnić kompleksowy
                                nadzór i bezpieczeństwo. Dzięki kamerom o wysokiej rozdzielczości, detekcji ruchu i możliwościom zdalnego dostępu
                                możesz monitorować swój obiekt z łatwością i spokojem.
                            </p>
                        ...
                        <article className="space-y-3 flex-1 min-w-xs ">
                            ...
                            <div className="flex flex-col lg:flex-row gap-3">
                                <div>
                                    ...
                                    <p className="pb-3">
                                        Zapewnij szybkie wykrywanie pożarów i chroń swoje mienie dzięki naszym zaawansowanym systemom sygnalizacji
                                        pożaru.
                                    </p>
                                </div>
                                <div>
                    ...
                    <div className="flex-[1_1_50%]">
                        ...
                        <article className="space-y-3 flex-1 min-w-xs ">
                            ...
                            <p className="text-lg pb-3">
                                ...
                                Nasz zespół doświadczonych elektryków jest wykwalifikowany w realizacji projektów każdej wielkości, zapewniając
                ...
                <Section className="flex flex-col lg:flex-row px-4 py-6 lg:py-12 justify-between items-center gap-4 lg:gap-8">
                    <div className="flex-[1_1_50%]">
                        <h2 className="text-3xl xl:text-4xl font-bold min-w-xs pb-6">Zarządzaj dostępem dzięki nowoczesnym systemom kontroli</h2>
                        <article className="space-y-3 flex-1 min-w-xs ">
                            <p className="xl:text-lg pb-3">
                                Oferujemy zaawansowane systemy kontroli dostępu, które pozwalają skutecznie zarządzać dostępem do Twojej własności.
                            </p>
                            ...
                            <div className="flex flex-col lg:flex-row gap-3">
                                <div>
                                    ...
                                    <p className="pb-3">
                                        Nasze systemy zapewniają precyzyjną kontrolę dostępu, eliminując nieuprawniony wstęp do chronionych obszarów.
                                    </p>
                                </div>
                                <div>
                                    <h3 className="pb-2 text-lg font-semibold">Inteligentne zarządzanie uprawnieniami</h3>
                                    <p className="pb-3">
                                        Dzięki naszym rozwiązaniom możliwe jest inteligentne zarządzanie uprawnieniami, dostosowane do indywidualnych
                                        potrzeb.
                                    </p>
                                </div>
                            </div>
            ...
            <section className="relative flex gap-6 px-7 lg:px-20 pb-6 pt-20 justify-between items-center bg-fixed bg-cover bg-gradient-to-r from-primary-100 to-primary-300 w-full shadow-md ">
                <div className="relative space-y-4 max-w-7xl mx-auto">
                    <h2 className="text-4xl lg:text-5xl text-bg-100/90 font-bold flex-auto min-w-xs text-center">Zabezpiecz z nami swoją własność</h2>
